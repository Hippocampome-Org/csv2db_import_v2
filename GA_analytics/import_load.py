...
# Try importing the Google API client library
try:
    from googleapiclient.discovery import build
except ImportError:
    print("Installing 'google-api-python-client' package...")
    subprocess.check_call(['/usr/bin/python3.10', '-m', 'pip', 'install', 'google-api-python-client'])
    print("Package 'google-api-python-client' installed successfully.")
    from googleapiclient.discovery import build  # Re-import after installation

# Try importing the Google Auth library
try:
    import google.auth
except ImportError:
    print("Installing 'google-auth' package...")
    subprocess.check_call(['/usr/bin/python3.10', '-m', 'pip', 'install', 'google-auth'])
    print("Package 'google-auth' installed successfully.")
    import google.auth  # Re-import after installation

# Try importing the Google Auth OAuth library
try:
    from google_auth_oauthlib.flow import InstalledAppFlow
except ImportError:
    print("Installing 'google-auth-oauthlib' package...")
    subprocess.check_call(['/usr/bin/python3.10', '-m', 'pip', 'install', 'google-auth-oauthlib'])
    print("Package 'google-auth-oauthlib' installed successfully.")
    from google_auth_oauthlib.flow import InstalledAppFlow  # Re-import after installation

# Try importing the Google Auth HTTP library
try:
    import google.auth.transport.requests
except ImportError:
    print("Installing 'google-auth-httplib2' package...")
    subprocess.check_call(['/usr/bin/python3.10', '-m', 'pip', 'install', 'google-auth-httplib2'])
    print("Package 'google-auth-httplib2' installed successfully.")
    import google.auth.transport.requests  # Re-import after installation
...
try:
    ...
    subprocess.check_call(['/usr/bin/python3.10', '-m', 'pip', 'install', 'google-analytics-data'])
    print("Package 'google-analytics-data' installed successfully.")
...
try:
    ...
    subprocess.check_call(['/usr/bin/python3.10', '-m', 'pip', 'install', 'pandas'])
    print("Package 'pandas' installed successfully.")
...
try:
    ...
    subprocess.check_call(['/usr/bin/python3.10', '-m', 'pip', 'install', 'mysql-connector-python'])
...
try:
    ...
    subprocess.check_call(['/usr/bin/python3.10', '-m', 'pip', 'install', 'python-dotenv'])
    print("Package 'python-dotenv' installed successfully.")
