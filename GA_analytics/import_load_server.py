...
try:
    ...
    subprocess.check_call(['/usr/bin/python3.7', '-m', 'pip', 'install', 'google-analytics-data'])
...
try:
    ...
    subprocess.check_call(['/usr/bin/python3.7', '-m', 'pip', 'install', 'pandas'])
...
try:
    ...
    subprocess.check_call(['/usr/bin/python3.7', '-m', 'pip', 'install', 'python-dotenv'])
