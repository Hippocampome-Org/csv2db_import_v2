...
SELECT unique_id, 
GROUP_CONCAT(DISTINCT sl.sub_layer) as subregion,
...
neurite as full_loc, COUNT(nq.filtered_total_length) as values_count,
AVG(nq.filtered_total_length) as length_mean, STD(nq.filtered_total_length) as length_std, 
AVG(nq.convexhull) as convex_hull_mean, STD(nq.convexhull) as convex_hull_std
